...
public class MainActivity extends AppCompatActivity {
    ...
    public void onButtonClick(View view) {
        editTextMake = (EditText) findViewById(R.id.inputMake); /** Cherche et prend la valeur de l id**/
        editTextYear = (EditText) findViewById(R.id.inputYear);
        editTextColor = (EditText) findViewById(R.id.inputColor);

        String make = editTextMake.getText().toString(); /** Stock dans make ce qu on a ecrit dans l app
         **/
